...
const styles = StyleSheet.create({
  ...
  paragraphInput: { color: theme.text, fontSize: 15, backgroundColor: theme.surface, borderWidth: 1, borderColor: theme.border, borderRadius: 8, padding: 10, minHeight: 80, textAlignVertical: "top" },
  callout: { backgroundColor: theme.surface, borderLeftWidth: 3, borderLeftColor: theme.accent, borderRadius: 6, padding: 10 },
  ...
  itemInput: { flex: 1, backgroundColor: theme.surface, borderWidth: 1, borderColor: theme.border, borderRadius: 8, color: theme.text, padding: 8, marginRight: 6 },
  tableRow: { flexDirection: "row", marginBottom: 4 },
  cellInput: { flex: 1, backgroundColor: theme.surface, borderWidth: 1, borderColor: theme.border, borderRadius: 6, color: theme.text, padding: 6, marginRight: 4, fontSize: 13 },
