...
const styles = StyleSheet.create({
  ...
  emptyTitle: { fontFamily: theme.font.sansSemi, fontSize: 18, color: "#F5F3EE", marginBottom: 8 },
  emptySub: { fontFamily: theme.font.sans, fontSize: 14, color: "#A1A5AD", marginBottom: 20 },
