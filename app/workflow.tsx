...
const styles = StyleSheet.create({
  ...
  stageNumber: { fontFamily: theme.font.monoMedium, fontSize: 12, color: "#2F6BFF", letterSpacing: 1.5 },
  stageTitle: { fontFamily: theme.font.sansSemi, fontSize: 18, color: "#F5F3EE" },
  stageDescription: { fontFamily: theme.font.sans, fontSize: 14, color: "#A1A5AD", lineHeight: 21, marginBottom: 16 },
  specimenBox: {
    backgroundColor: "#15181D",
    borderWidth: 1,
    borderColor: "#272B32",
  ...
  specimenLabel: { fontFamily: theme.font.monoMedium, fontSize: 10, color: "#727780", letterSpacing: 1, marginBottom: 6 },
  specimenCode: { fontFamily: theme.font.mono, fontSize: 11, color: "#F5F3EE", lineHeight: 18 },
  ...
  compColHead: { fontFamily: theme.font.monoMedium, fontSize: 11, letterSpacing: 1, color: "#A1A5AD" },
  compRow: {
    flexDirection: "row",
    borderBottomWidth: 1,
    borderColor: "#272B32",
  ...
  compCell: { fontFamily: theme.font.sans, fontSize: 13, color: "#A1A5AD" },
