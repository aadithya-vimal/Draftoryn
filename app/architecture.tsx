...
const styles = StyleSheet.create({
  ...
  layerNum: { fontFamily: theme.font.monoMedium, fontSize: 11, color: theme.accent, letterSpacing: 1 },
  layerContent: { flex: 1 },
  layerTitle: { fontSize: 18, color: theme.text, marginBottom: 8 },
  layerDesc: { fontFamily: theme.font.sans, fontSize: 14, color: theme.textSecondary, lineHeight: 21, marginBottom: 14 },
  ...
  specimenLabel: { fontFamily: theme.font.monoMedium, fontSize: 10, color: theme.muted, letterSpacing: 1, marginBottom: 4 },
  specimenCode: { fontFamily: theme.font.mono, fontSize: 11, color: theme.accent },
